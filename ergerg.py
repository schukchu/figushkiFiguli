...
def create():
   ...
   customers = [
      ...
      ('00008', 'Litzy', 'Yates', 'female'), ('00009', 'Jaxon', 'Mills', 'male'),
...
while True:
  userNum = int(input("Enter 1 if you wish to create a database \nEnter 2 if you wish to do smt idk with the database \n"))
